...
![cocot51_main08](https://user-images.githubusercontent.com/88039287/127476454-8fd070a0-bd15-4e0b-b566-90760fa2365f.jpg)

cocot51のビルドガイドになります。
cocot51は中央に1uトラックボールを備えていることが一つの特徴ですが、トラックボールなしでキーボードのみで組み立てることも可能です。
...
0. 部品確認
  ...
  ※β版ではトッププレート・トラックボールカバープレート・トラックボール固定プレートは表面のみマットブラックで、裏面は無塗装になります。無塗装の面は組み立ててしまえば見えなくなりますが、予めご了承ください。
  〇左が表面、右が裏面
  ![bg_00_parts03](https://user-images.githubusercontent.com/88039287/127670719-c8ee7e0c-1f94-49b6-9bc3-10f4cdd8ae1b.jpg)

  その他上述の「キット以外に必要なもの」および「オプション部品」を揃えた上で組み立てに取り掛かってください。

1. ダイオード
  PCB裏面に、写真の向きでダイオードをはんだ付けします。ダイオードの表面の線と、PCBのシルクの線の向きが揃うように配置してください。予め片側にはんだを盛っておき、溶かしながらピンセットでダイオードを押さえつけると固定しやすくなります。全51箇所はんだ付けを行ってください。
  ![bg_01_diode](https://user-images.githubusercontent.com/88039287/127675355-a4cb0ba7-0db6-4b36-bb3c-1e8090c5fc67.jpg)

2. MXソケット
  PCB裏面に、写真の向きでソケットをはんだ付けします。全51箇所はんだ付けを行ってください。
...
8. 組み立て
  ...
  6で組み立てたトラックボールパーツをトラックボール固定プレートに通します。レベル変換基板を斜めにして通します。
...
9. アクリル積層ケース（オプション）
  ...
  シリコンシートのカッティング補助用に、[こちら](https://github.com/aki27kbd/cocot51/blob/main/doc/cocot51_silicon.pdf?raw=true)のシートをダウンロードし、**拡大率100%** で印刷してください。用紙に合わせて印刷してしまうとキースイッチの位置がずれてしまうのでご注意ください。
...
[yfuku様のページ](https://yfuku.com/blog/keyboard/trackball_with_touch_sensor/)を参考に、トラックボールを扱う手に応じてY軸を45度回転させています。
[右手用](https://github.com/aki27kbd/cocot51/blob/main/firmware/cocot51_trackball_right.zip?raw=true)
[左手用](https://github.com/aki27kbd/cocot51/blob/main/firmware/cocot51_trackball_left.zip?raw=true)
.hexファイルをQMK ToolboxなどでProMicroに書き込めば、以降[ReMap](https://remap-keys.app/configure)でキーマップを変更することが可能です。

ソースコードは[こちら](https://github.com/aki27kbd/qmk_firmware/tree/master/keyboards/cocot51)を参照ください。

## 終わりに
何かトラブルがあれば[Twitterアカウント](https://twitter.com/aki2716110826)までご連絡ください。
